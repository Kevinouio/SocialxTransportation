...
def evaluate_rumor_with_llm(rumor, street_names):
    ...
    relevant_streets = [street for street, score in
                        zip(classification_result["labels"], classification_result["scores"]) if score > 0.5]
    print(f'{relevant_streets} And here the sentiment results are {sentiment_results}')
    return sentiment_results, relevant_streets
...
if __name__ == '__main__':
    ...
    sample_rumor = "There is an active shooter on Harold Street! Avoid the area."
